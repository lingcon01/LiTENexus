...
* Quantum-level microscopic property prediction
...
### Quantum-Chemical Grounded Representation Learning
...
Microscopic Quantum Dynamics
        ↓
Quantum Chemical Information Injection (QCII)
        ↓
...
* Quantum-chemically grounded molecular representation learning
...
from litenexus import LiTENCLIP

retriever = LiTENCLIP.from_pretrained("liten-clip")
hits = retriever.search(query="EGFR inhibitor")
```
